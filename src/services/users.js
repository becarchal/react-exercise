...
export function getUserProfile(username) {
    var userInfoPromise = fetch(`api/users/${username}?client_id=8a9bbf3c53006781069d&client_secret=6febf2880914f1e4fe825813215d32f435050fab`).then(response=>{
        return response.json();
    });
    var orgsPromise = fetch(`api/users/${username}/orgs?client_id=8a9bbf3c53006781069d&client_secret=6febf2880914f1e4fe825813215d32f435050fab`).then(response=>{
        return response.json()
    });
